-- REPOTA DATABASE
-- repotadb
-- All queries needed for the app's activities
...
FROM jobreports jr
         INNER JOIN customers cust ON jr.job_report_id = cust.job_report_id
         INNER JOIN workers wkr ON jr.worker_id = wkr.worker_id
WHERE wkr.worker_id = ?;

-- create a report
START TRANSACTION;
INSERT INTO jobreports (job_report_id, worker_id, date_stamp, vehicle_model, vehicle_reg, vehicle_location,
